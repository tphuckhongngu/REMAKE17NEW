        ...
        for enemy, bullets_hit in hits.items():
            ...
            if died:
                if enemy.__class__.__name__ == 'Boss':
                    ...
                    # extra debug: list boss-like sprites and their healths/ids
                    try:
                        boss_list = []
                    ...
                    # Mark boss_spawned False and let post_update_boss_check start the pending window
                    try:
                        try:
                        ...
                        # do NOT set victory_pending here; post_update_boss_check will verify no other boss-like enemies remain
                    except Exception:
                        pass
                else:
                    try:
        ...
        try:
            ...
            if not getattr(game, 'victory_pending', False):
                ...
                try:
                    ...
                    game.victory_pending_at = now
                try:
                    print("DEBUG: No Boss instances remain - scheduling VICTORY (pending)")
                except Exception:
                    pass
                return
